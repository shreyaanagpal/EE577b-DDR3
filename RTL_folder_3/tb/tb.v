...
module tb();
`define IPNUT_FILE_NAME "ddr3_test_pattern1.dat" //Please MANUALLY modify the test pattern name
`define TRACE_FILE_NAME "ddr3_test.trc"  //Not used 
`define DUMP_FILE_NAME  "ddr3_out1.dump" // Please MANUALLY modify the dump file name
...
$sdf_annotate("../sdf/ddr3_controller.sdf",XCON,,,"TYPICAL","1.0:1.0:1.0", "FROM_MTM");
   ...
   initial
	 begin
		...
		// fin = $fopen("ddr3_test_pattern.dat","r");
